...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          alert("trima kasih, saya akan membalas anda sesempat mungkin");
  ...
  return (
    <div className=" xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        <p className={styles.sectionSubText}>Hubungi Kami </p>
        ...
        >
          <label className=" flex flex-col">
            <span className=" text-white font-medium mb-4">Masukkan Nama</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label className=" flex flex-col">
            <span className=" text-white font-medium mb-4">Masukkan Email</span>
            <input
              type="email"
              name="email"
              value={form.email}
          ...
          <label className=" flex flex-col">
            <span className=" text-white font-medium mb-4">Masukkan Pesan</span>
            <textarea
              rows="7"
              name="message"
              value={form.message}
